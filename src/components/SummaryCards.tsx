...
export const SummaryCards: React.FC<SummaryCardsProps> = React.memo(({
  ...
  return (
    <div className="summary-cards">
      ...
      {/* Row 2: Cost Breakdown (always visible) */}
      <div className="summary-cards-row">
        <div className="summary-card summary-card-breakdown summary-card-compute">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.compute) : fmt(0)}</div>
          </div>
        </div>
        <div className="summary-card summary-card-breakdown summary-card-licensing">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.osLicensing + breakdown.sql) : fmt(0)}</div>
          </div>
        </div>
        <div className="summary-card summary-card-breakdown summary-card-storage">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.storage) : fmt(0)}</div>
          </div>
        </div>
        <div className="summary-card summary-card-breakdown summary-card-backup">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.backup) : fmt(0)}</div>
          </div>
        </div>
        <div className="summary-card summary-card-breakdown summary-card-monitor">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.monitor) : fmt(0)}</div>
          </div>
        </div>
        <div className="summary-card summary-card-breakdown summary-card-asr">
          ...
          <div className="breakdown-info">
            ...
            <div className="card-value">{breakdown ? fmt(breakdown.siteRecovery) : fmt(0)}</div>
          </div>
        </div>
      </div>
    </div>
